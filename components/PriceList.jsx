...
export default function PriceList() {
    ...
    return (
        <>
            <div className="bg-[#090a06] relative flex flex-col justify-center items-center h-80 md:h-130 lg:h-140">  
              ...
              <div className="flex">
                <h2 className="text-[#ffffff] text-base md:text-2xl lg:text-3xl">Price List</h2>  
              </div>
              
              <div className="flex flex-row gap-2 md:gap-14 lg:gap-10">
