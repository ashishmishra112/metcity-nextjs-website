...
export default function About() {
    ...
    return (
        <>
            <div className="flex flex-col md:flex md:flex-row bg-[#f4f1e8] gap-6 md:gap-1 lg:gap-2 justify-center items-center h-190 md:h-110 lg:h-140">
            <div className="md:w-1/2 flex justify-center items-center"> 
            <div className="min-h-75 md:min-h-80 lg:min-h-112.5 lg:w-100 bg-white bg-[url('/assets/met.jpg'),url('/assets/metcity-bg.webp')] bg-[length:30%_20%,100%_50%] bg-[position:top,bottom] bg-no-repeat"> 
              ...
              <div className="flex flex-col items-center md:items-start gap-2 md:gap-2 md:w-1/2">
                <h2 className="text-green-600 text-sm md:text-lg lg:text-3xl md:leading-5">Reliance Industrial Plots/ Reliance MET In NCR <br className="hidden md:block"/> Highlights</h2>
                <p className="text-[10px] lg:text-base px-6 text-center md:px-0 md:pr-7 lg:pr-18 md:text-left">
                ...
                <div className="flex flex-row md:items-center gap-2 md:pt-6 md:gap-4 lg:gap-8 pl-0 md:pl-4 lg:pl-12"> 
                <span className="text-xs md:text-[10px] lg:text-base font-semibold">Prime Locations </span> &#124; 
                <span className="text-xs md:text-[10px] lg:text-base font-semibold">Innovative Design </span> &#124; 
                <span className="text-xs md:text-[10px] lg:text-base font-semibold">Commitment to Quality</span>
                </div>
